...
loaddata(){
  ...
  const data=this.state.warehousedet
  ...
  getwarehouse(){
    ...
    axios.get('http://localhost:8012/warehouse').then(res=>{
...
//`${this.state.baseurl}/warehouse/add`
    axios.post( 'http://localhost:8012/warehouse',warehouse).then(res=>{
...
let filterdata=this.state.warehousedet.filter(val=>{
        ...
        return (
            <Container>
                <div className="App">
                    ...
                    <Row>
                    <Col md="5">
                    <center><h5>ADD WAREHOUSE</h5></center>
                    <Card>
                ...
                <FormGroup row>
                  ...
                  <Input id="pin"  onChange={(e) => {
                    ...
                    <Col md="1"></Col>
                    <Col md="6">
                    <center><h5>EDIT WAREHOUSE</h5></center>
                      
                      <Card>
                        <CardHeader>ALL WAREHOUSE</CardHeader>
                            <CardBody>
                            <b>Search</b>: <input
                            style={{ marginLeft: 5 }}
                            type="text"
                            ...
                            />
                             <DeleteIcon onClick={()=>this.setState({searchinput:'',searchdata:this.state.warehousedet})}></DeleteIcon>
        
                      {this.state.searchdata.length === 0 && <span>No records found!</span> }
                              {this.state.searchdata.map((wh,ind)=>{
                                return(
                                  <>
                                  <Card>
                                  <CardBody>
                                  <Row><Col>NAME:{' '}<b>{wh.name}</b></Col></Row>
                          <Row><Col>GST:{' '}<b>{wh.gstin}</b></Col></Row>
                          <Row><Col>PHONE:{' '}<b>{wh.phone}</b></Col></Row>
                          <Row><Col>EMAIL:{' '}<b>{wh.email}</b></Col></Row>
                          <Row><Col>ADDRESS:{' '}<b>{Object.values(wh.address).join()}</b></Col></Row>
                                  </CardBody>
                                  <CardFooter>
                                    <Button size="sm" color="primary" onClick={(e)=>this.editdata(ind,wh.id,e)}>EDIT</Button>
                                  </CardFooter>
                                </Card>
                                <br></br>
                                </>
                    ...
                    <ModalFooter>
                      <Button color="success" onClick={this.postwarehouse}>CONFIRM</Button>
            ...
            <CardBody>
                ...
                <FormGroup>
                  ...
                  <Input id="pin" value={this.state.upin} onChange={(e) => {
                    ...
                    <ModalFooter>
                      <Button color="success" onClick={this.putwarehouse}>EDIT</Button>
